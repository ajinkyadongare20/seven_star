            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="position-relative overflow-hidden ps-5 pt-5 h-100" style="min-height: 400px;">
                        <img class="position-absolute w-100 h-100" src="<?php bloginfo('template_directory'); ?>/img/about.jpg" alt="" style="object-fit: cover;">
        ...
        <div class="row g-0">
            <div class="col-xl-3 col-sm-6 wow fadeIn" data-wow-delay="0.1s">
                <div class="position-relative">
                    <img class="img-fluid w-100" src="<?php bloginfo('template_directory'); ?>/img/fact-1.jpg" alt="">
            ...
            <div class="col-xl-3 col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                <div class="position-relative">
                    <img class="img-fluid w-100" src="<?php bloginfo('template_directory'); ?>/img/fact-2.jpg" alt="">
                    <div class="facts-overlay">
            ...
            <div class="col-xl-3 col-sm-6 wow fadeIn" data-wow-delay="0.5s">
                <div class="position-relative">
                    <img class="img-fluid w-100" src="<?php bloginfo('template_directory'); ?>/img/fact-3.jpg" alt="">
                    <div class="facts-overlay">
            ...
            <div class="col-xl-3 col-sm-6 wow fadeIn" data-wow-delay="0.7s">
                <div class="position-relative">
                    <img class="img-fluid w-100" src="<?php bloginfo('template_directory'); ?>/img/fact-4.jpg" alt="">
                    <div class="facts-overlay">
                ...
                <div class="col-lg-7 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="owl-carousel testimonial-carousel">
                        <div class="testimonial-item">
                            <img class="img-fluid mb-4" src="<?php bloginfo('template_directory'); ?>/img/testimonial-1.jpg" alt="">
                        ...
                        <div class="testimonial-item">
                            <img class="img-fluid mb-4" src="<?php bloginfo('template_directory'); ?>/img/testimonial-2.jpg" alt="">
                            <p class="fs-5">Dolores sed duo clita tempor justo dolor et stet lorem kasd labore dolore lorem ipsum. At lorem lorem magna ut et, nonumy et labore et tempor diam tempor erat.</p>
                            <div class="bg-primary mb-3" style="width: 60px; height: 5px"></div>
                            <h5>Client Name</h5>
                            <span>Profession</span>
